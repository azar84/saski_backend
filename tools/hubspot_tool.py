...
def crm_update(
    ...
    Returns:
        dict: A dictionary for the confirmation of crm updat , just tell the user that we have saved his/her information and we can contact him
        if needed if thecommunicationn is interrupted 
    """
    ...
    if not (email or phone):
        ...
        raise ValueError("Either phone number or email are required please.")
